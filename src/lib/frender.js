...
define('frender/Element',['require','./core/guid','./mixin/Eventful','./mixin/Transformable','./mixin/Animatable','./core/util'],function(require) {
     ...
     * @constructor
     * @extends {module:frender/mixin/Animatable}
    ...
    Element.prototype = {
        ...
        /**
         * frender 实例对象，会在 element 添加到 frender 实例中后自动赋值
         * frender instance will be assigned when element is associated with frender
         * @name module:/frender/Element#__zr
         * @type {module:frender/frender}
         */
        __zr: null,
         ...
         * @name module:/frender/Element#ignore
         * @type {boolean}
         * @default false
         */
        ignore: false,
         ...
         * 该路径会继承被裁减对象的变换
         * @type {module:frender/graphic/Path}
        ...
        /**
         * @param {module:frender/graphic/Path} clipPath
         */
        ...
        /**
         * Add self from frender instance.
         * Not recursively because it will be invoked when element added to storage.
         * @param {module:frender/frender} zr
         */
        ...
        /**
         * Remove self from frender instance.
         * Not recursively because it will be invoked when element added to storage.
         * @param {module:frender/frender} zr
         */
...
/*!
 * frender, a high performance 2d drawing library.
 *
 * Copyright (c) 2013, Baidu Inc.
 * All rights reserved.
 *
 * LICENSE
 * https://github.com/ecomfe/frender/blob/master/LICENSE.txt
 */
// Global defines
define('frender/frender',['require','./core/guid','./core/env','./core/util','./Handler','./Storage','./animation/Animation','./dom/HandlerProxy','./Painter'],function(require) {
     ...
     * @type {string}
     */
    frender.version = '3.4.1';

    /**
     * Initializing a frender instance
     ...
     * @return {module:frender/frender}
     */
    frender.init = function(dom, opts) {
        var zr = new Frender(guid(), dom, opts);
        instances[zr.id] = zr;
        return zr;
    };

    /**
     * Dispose frender instance
     * @param {module:frender/frender} zr
     */
    frender.dispose = function (zr) {
        if (zr) {
            zr.dispose();
        }
        else {
    ...
    /**
     * Get frender instance by id
     * @param {string} id frender instance id
     * @return {module:frender/frender}
     */
    frender.getInstance = function (id) {
        return instances[id];
    };

    frender.registerPainter = function (name, Ctor) {
    ...
    /**
     * @module frender/frender
     */
    /**
     * @constructor
     * @alias module:frender/frender
     * @param {string} id
     ...
     */
    var Frender = function(id, dom, opts) {
        ...
        if (useVML) {
            if (!painterCtors.vml) {
                throw new Error('You need to require \'frender/vml/vml\' to support IE8');
            }
            rendererType = 'vml';
        }
        ...
        /**
         * @type {module:frender/animation/Animation}
         */
    ...
    Frender.prototype = {
        ...
        /**
         * 添加元素
         * @param  {module:frender/Element} el
         */
        add: function (el) {
        ...
        */
        ...
        refreshImmediately: function () {
            ...
            // Or it will cause frender refreshes again and again.
         ...
         * @param {module:frender/graphic/Path} e
         * @param {number} width
         * @param {number} height
         */
...
define('frender/Handler',['require','./core/util','./mixin/Draggable','./mixin/Eventful'],function (require) {
    ...
    /**
     * @alias module:frender/Handler
     * @constructor
     * @extends module:frender/mixin/Eventful
     * @param {module:frender/Storage} storage Storage instance.
     * @param {module:frender/Painter} painter Painter instance.
     * @param {module:frender/dom/HandlerProxy} proxy HandlerProxy instance.
    ...
    Handler.prototype = {
         ...
         * @param {number} x
         * @param {number} y
         * @param {module:frender/graphic/Displayable} exclude
         * @method
         */
...
define('frender/Layer',['require','./core/util','./config','./graphic/Style','./graphic/Pattern'],function (require) {
    ...
    /**
     * @alias module:frender/Layer
     * @constructor
     * @extends module:frender/mixin/Transformable
     * @param {string} id
     * @param {module:frender/Painter} painter
     * @param {number} [dpr]
     */
 ...
 */
 define('frender/Painter',['require','./config','./core/util','./core/log','./core/BoundingRect','./core/timsort','./Layer','./animation/requestAnimationFrame','./graphic/Image'],function (require) {
    ...
    /**
     * @alias module:frender/Painter
     * @constructor
     * @param {HTMLElement} root 绘图容器
     * @param {module:frender/Storage} storage
     * @param {Ojbect} opts
     */
    var Painter = function (root, storage, opts) {
        ...
        /**
         * @type {Object.<string, module:frender/Layer>}
         * @private
         */
    ...
    Painter.prototype = {
        ...
        insertLayer: function (zlevel, layer) {
            ...
            // But it still under management of frender.
            if (!layer.virtual) {
                if (prevLayer) {
        ...
        /**
         * 获取所有已创建的层
         * @param {Array.<module:frender/Layer>} [prevLayer]
         */
        getLayers: function () {
            return this._layers;
        },
...
define('frender/Storage',['require','./core/util','./core/env','./container/Group','./core/timsort'],function (require) {
    ...
    Storage.prototype = {
         ...
         *
         * 详见{@link module:frender/graphic/Displayable.prototype.updateDisplayList}
         * @return {Array.<module:frender/graphic/Displayable>}
         */
 ...
 * 动画主类, 调度和管理所有动画控制器
 *
 * @module frender/animation/Animation
 * @author pissang(https://github.com/pissang)
 */
...
define('frender/animation/Animation',['require','../core/util','../core/event','./requestAnimationFrame','./Animator'],function(require) {
    ...
    /**
     * @typedef {Object} IfrenderStage
     * @property {Function} update
     */

    /**
     * @alias module:frender/animation/Animation
     * @constructor
     * @param {Object} [options]
     * @param {Function} [options.onframe]
     * @param {IfrenderStage} [options.stage]
     * @example
    ...
    Animation.prototype = {
        ...
        /**
         * 添加 clip
         * @param {module:frender/animation/Clip} clip
         */
        ...
        /**
         * 添加 animator
         * @param {module:frender/animation/Animator} animator
         */
         ...
         * @return {module:frender/animation/Animation~Animator}
         */
        // TODO Gap
...
define('frender/animation/Animator',['require','./Clip','../tool/color','../core/util'],function (require) {
    ...
    /**
     * @alias module:frender/animation/Animator
     * @constructor
     * @param {Object} target
     * @param {boolean} loop
    ...
    Animator.prototype = {
         ...
         *         动画缓动函数，详见{@link module:frender/animation/easing}
         * @return {module:frender/animation/Animator}
         */
        ...
        /**
         * @return {Array.<module:frender/animation/Clip>}
         */
        getClips: function () {
 ...
 * @exports frender/animation/easing
 */
...
define('frender/core/bbox',['require','./vector','./curve'],function (require) {
    ...
    /**
     * @memberOf module:frender/core/bbox
     * @param {number} x0
     * @param {number} y0
     * @param {number} x1
     * @param {number} y1
...
define('frender/core/BoundingRect',['require','./vector','./matrix'],function(require) {
    ...
    BoundingRect.prototype = {
         ...
         * @param  {module:frender/core/BoundingRect} b
         * @return {Array.<number>}
         */
    ...
    /**
     * @param {Object|module:frender/core/BoundingRect} rect
     * @param {number} rect.x
     * @param {number} rect.y
...
define('frender/core/curve',['require','./vector'],function(require) {
    ...
    /**
     * 计算三次贝塞尔值
     * @memberOf module:frender/core/curve
     * @param  {number} p0
     * @param  {number} p1
     * @param  {number} p2
     * @param  {number} p3
...
define('frender/core/event',['require','../mixin/Eventful','./env'],function(require) {
     ...
     * Notice: do not do that in frender. Upper application
     * do that if necessary.
     *
     * @memberOf module:frender/core/event
     * @method
...
define('frender/core/LRU',['require'],function (require) {
    ...
    var LinkedList = function () {
        ...
        /**
         * @type {module:frender/core/LRU~Entry}
         */
        this.head = null;
     ...
     * @param  {} val
     * @return {module:frender/core/LRU~Entry}
     */
     ...
     * @param  {module:frender/core/LRU~Entry} entry
     */
...
define('frender/core/PathProxy',['require','./curve','./vector','./bbox','./BoundingRect','../config'],function (require) {
    ...
    /**
     * @alias module:frender/core/PathProxy
     * @constructor
     */
    ...
    PathProxy.prototype = {
         ...
         * @return {module:frender/core/PathProxy}
         */
        ...
        /**
         * 添加子路径
         * @param {module:frender/core/PathProxy|Array.<module:frender/core/PathProxy>} path
         */
...
define('frender/core/util',['require'],function(require) {
    ...
    /**
     * @memberOf module:frender/core/util
     * @param {*} target
     * @param {*} source
...
define('frender/graphic/Displayable',['require','../core/util','./Style','../Element','./mixin/RectText'],function (require) {
    ...
    /**
     * @alias module:frender/graphic/Displayable
     * @extends module:frender/Element
     * @extends module:frender/graphic/mixin/RectText
     */
    function Displayable(opts) {
        ...
        /**
         * @type {module:frender/graphic/Style}
         */
    ...
    Displayable.prototype = {
         ...
         * @name module:frender/graphic/Displayable#__dirty
         * @type {boolean}
         */
        __dirty: true,
         ...
         * @name module:/frender/graphic/Displayable#invisible
         * @type {boolean}
         * @default false
         */
        invisible: false,
        ...
        /**
         * @name module:/frender/graphic/Displayable#z
         * @type {number}
         * @default 0
         */
        z: 0,
         ...
         * @name module:/frender/graphic/Displayable#zlevel
         * @type {number}
         * @default 0
         */
        zlevel: 0,
        ...
        /**
         * 是否可拖拽
         * @name module:/frender/graphic/Displayable#draggable
         * @type {boolean}
         * @default false
         */
        draggable: false,
        ...
        /**
         * 是否相应鼠标事件
         * @name module:/frender/graphic/Displayable#silent
         * @type {boolean}
         * @default false
         */
        silent: false,
         ...
         * @name module:/frender/graphic/Displayable#cursor
         * @type {string}
         */
        cursor: 'pointer',
         ...
         * @name module:/frender/graphic/Displayable#rectHover
         * @type {string}
         */
        rectHover: false,
...
define('frender/graphic/Image',['require','./Displayable','../core/BoundingRect','../core/util','../core/LRU'],function (require) {
    ...
    /**
     * @alias frender/graphic/Image
     * @extends module:frender/graphic/Displayable
     * @constructor
     * @param {Object} opts
     */
...
define('frender/graphic/Path',['require','./Displayable','../core/util','../core/PathProxy','../contain/path','./Pattern'],function (require) {
    ...
    /**
     * @alias module:frender/graphic/Path
     * @extends module:frender/graphic/Displayable
     * @constructor
     * @param {Object} opts
     */
    function Path(opts) {
        ...
        /**
         * @type {module:frender/core/PathProxy}
         * @readOnly
         */
...
define('frender/graphic/Style',['require'],function (require) {
    ...
    Style.prototype = {
         ...
         * @param {frender/graphic/Style} otherStyle
        ...
        /**
         * Clone
         * @return {frender/graphic/Style} [description]
         */
        clone: function () {
...
define('frender/vml/Painter',['require','../core/log','./core'],function (require) {
    ...
    /**
     * @alias module:frender/vml/Painter
     */
...
/**
 * 贝塞尔平滑曲线
 * @module frender/shape/util/smoothBezier
 * @author pissang (https://www.github.com/pissang)
...
define('frender/graphic/helper/smoothBezier',['require','../../core/vector'],function (require) {
    ...
    /**
     * 贝塞尔平滑曲线
     * @alias module:frender/shape/util/smoothBezier
 ...
 * @module frender/shape/util/smoothSpline
 * @author pissang (https://www.github.com/pissang)
 *         Kener (@Kener-林峰, kener.linfeng@gmail.com)
 *         errorrik (errorrik@gmail.com)
 */
define('frender/graphic/helper/smoothSpline',['require','../../core/vector'],function (require) {
    ...
    /**
     * @alias module:frender/shape/util/smoothSpline
     * @param {Array} points 线段顶点数组
     * @param {boolean} isLoop
     * @return {Array}
     */
...
/**
 * 贝塞尔曲线
 * @module frender/shape/BezierCurve
 */
...
/**
 * 水滴形状
 * @module frender/graphic/shape/Droplet
 */
...
/**
 * 椭圆形状
 * @module frender/graphic/shape/Ellipse
 */
...
/**
 * 心形
 * @module frender/graphic/shape/Heart
 */
...
/**
 * 直线
 * @module frender/graphic/shape/Line
 */
...
/**
 * 矩形
 * @module frender/graphic/shape/Rect
 */
...
/**
 * 圆环
 * @module frender/graphic/shape/Ring
 */
...
/**
 * 玫瑰线
 * @module frender/graphic/shape/Rose
 */
...
/**
 * 扇形
 * @module frender/graphic/shape/Sector
 */
...
/**
 * n角星（n>3）
 * @module frender/graphic/shape/Star
 */
